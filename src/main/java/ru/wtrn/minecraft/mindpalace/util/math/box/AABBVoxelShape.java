...
public class AABBVoxelShape extends SliceShape {
    ...
    @Override
    protected double get(Axis axis, int p_83258_) {
    ...
    @Override
    public double min(Axis axis, double one, double two) {
        return min(axis);
    }
    
    @Override
    public double max(Axis axis, double one, double two) {
        return max(axis);
    }
    
    @Override
    protected int findIndex(Axis axis, double value) {
        throw new UnsupportedOperationException();
    }
    ...
    @Override
    public double collide(Axis axis, AABB bb, double value) {
        throw new UnsupportedOperationException();
    }
